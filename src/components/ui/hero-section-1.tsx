                ...
                <section className="bg-background pb-16 pt-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        ...
                        <div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
                            ...
                            <div className="flex">
                                <div className="mx-auto h-5 flex items-center justify-center text-sm font-semibold text-gray-700 dark:text-gray-300">
                                    Claude
                                </div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-4 flex items-center justify-center text-sm font-semibold text-gray-700 dark:text-gray-300">
                                    Gemini
                                </div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-7 flex items-center justify-center text-sm font-semibold text-gray-700 dark:text-gray-300">
                                    Mistral
                                </div>
                            </div>
                            <div className="flex">
                                <div className="mx-auto h-6 flex items-center justify-center text-sm font-semibold text-gray-700 dark:text-gray-300">
                                    LLaMA
                                </div>
                            </div>
                        </div>
